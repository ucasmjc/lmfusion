...
class Qwen2Attention(nn.Module):
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        #print(query_states.shape,key_states.shape,value_states.shape,hidden_states,hidden_shape,self.v_proj(hidden_states).shape)
...
class Qwen2ForCausalLM1(Qwen2PreTrainedModel, GenerationMixin):
