...
#export LOG_PATH="/work/share/projects/mjc/lmfusion/log/log.txt"
...
RUN_NAME=gen
OUTP_DIR=checkpoints/generation
...
torchrun \
 ...
 --master_port=${master_port} \
   ...
   # > /work/share/projects/mjc/lmfusion/log/mutil_log.txt 2>&1  # 保存所有输出到 log.txt
