        ...
        if labels is not None:
            ...
            if ar_with_non_ar and image_gen:
                ...
                if not only_compute_ar_loss:
                    ...
                    loss = loss_ar + loss_non_ar if (not torch.isnan(loss_ar) and not torch.isnan(loss_non_ar)) else (loss_ar if not torch.isnan(loss_ar) else (loss_non_ar if not torch.isnan(loss_non_ar) else float('nan')))
